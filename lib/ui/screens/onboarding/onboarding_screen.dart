...
import 'package:rentease/data/cubits/system/fetch_system_settings_cubit.dart';
import 'package:rentease/data/model/system_settings_model.dart';
import 'package:rentease/utils/Extensions/extensions.dart';
import 'package:rentease/utils/Lottie/lottieEditor.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(accentColor.red.toString());
    final slidersList = [
      {
