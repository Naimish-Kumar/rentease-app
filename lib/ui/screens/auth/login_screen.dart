...
import 'package:rentease/data/repositories/auth_repository.dart';
import 'package:rentease/exports/main_export.dart';
import 'package:rentease/ui/screens/home/home_screen.dart';
import 'package:rentease/utils/login/apple_login/apple_login.dart';
import 'package:rentease/utils/login/google_login/google_login.dart';
import 'package:rentease/utils/login/lib/login_status.dart';
import 'package:rentease/utils/login/lib/login_system.dart';
import 'package:rentease/utils/strings.dart';
import 'package:rentease/utils/validator.dart';
          ...
          Row(
            children: [
              Expanded(
                child: Divider(
                  thickness: 1,
                  color: context.color.inverseSurface.withOpacity(0.3),
                ),
              ),
              Padding(
