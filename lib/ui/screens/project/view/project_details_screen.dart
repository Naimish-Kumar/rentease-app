...
import 'package:rentease/app/routes.dart';
import 'package:rentease/data/cubits/project/delete_project_cubit.dart';
import 'package:rentease/data/cubits/project/fetchMyProjectsListCubit.dart';
import 'package:rentease/data/cubits/project/fetchProjectDetailsCubit.dart';
import 'package:rentease/data/helper/widgets.dart';
import 'package:rentease/data/model/project_model.dart';
import 'package:rentease/data/repositories/system_repository.dart';
import 'package:rentease/ui/screens/proprties/property_details.dart';
import 'package:rentease/ui/screens/widgets/animated_routes/blur_page_route.dart';
import 'package:rentease/ui/screens/widgets/blurred_dialoge_box.dart';
import 'package:rentease/ui/screens/widgets/gallery_view.dart';
import 'package:rentease/utils/AppIcon.dart';
import 'package:rentease/utils/Extensions/extensions.dart';
import 'package:rentease/utils/cloud_state/cloud_state.dart';
...
import 'package:rentease/utils/typedefs.dart';
import 'package:rentease/utils/ui_utils.dart';
import 'package:rentease/utils/video_player/video_player_widget.dart';
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    SliverAppBar(
                      ...
                      shadowColor:
                          context.color.inverseSurface.withOpacity(0.3),
      ...
      children: [
        ...
        Expanded(
          child: CustomText(
            ...
            color: context.color.inverseSurface.withOpacity(0.4),
            fontSize: context.font.large,
          ),
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        ...
        title: CustomText(
          widget.title,
          color: context.color.inverseSurface.withOpacity(0.9),
          fontSize: context.font.large,
        ),
