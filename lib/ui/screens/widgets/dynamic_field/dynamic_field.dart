...
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
//                             CustomText(pickedFilePath.split("/").last)
//                                 .setMaxLines(lines: 1)
//                                 .bold(weight: FontWeight.w500),
...
//                     width: 10.rw(context),
//                   ),
//                   CustomText(widget.parameters['name'])
//                       .size(context.font.large)
//                       .bold(weight: FontWeight.w500)
//                       .color(context.color.textColorDark)
//                 ],
...
//                               child: CustomText(widget.radioValues?[index]).color(
//                                   selectedRadio.value ==
//                                           widget.radioValues?[index]
//                                       ? context.color.tertiaryColor
...
//                           },
//                         ),
//                         CustomText(widget.radioValues?[index])
//                       ],
//                     );
//                   }))
//             ],
...
//                                 width: 5,
//                               ),
//                               CustomText(widget.checkValues?[index]).color(
//                                   value.contains(widget.checkValues?[index])
//                                       ? context.color.tertiaryColor
//                                       : context.color.textLightColor)
//                             ],
...
//                         },
//                       ),
//                       CustomText(widget.checkValues?[index])
//                     ],
//                   );
//                 },
//               ),
